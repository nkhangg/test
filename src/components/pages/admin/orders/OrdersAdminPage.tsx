...
import { BoxTitle, Comfirm, DialogDateChooser, LoadingPrimary, RowStatusOrders, Table, TippyChooser, UpdateStateOrderDialog } from '@/components';
...
import { OrderAdminPageContext, OrderAdminPageProvider } from '@/contexts/OrderAdminPageProvider';
            ...
            {anotherLayout && (
                <OrderAdminPageProvider>
                    <BoxTitle mt="mt-0" mbUnderline="mb-0" border={false} title="ORDER MANAGEMENT" className="">
                        ...
                        <UpdateStateOrderDialog idOpen={dataOpen} open={open} setOpen={setOpen} />
                    </BoxTitle>
                </OrderAdminPageProvider>
            )}
        </div>
