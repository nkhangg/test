      ...
      (async () => {
         dispatch(
            addPayment({
               ...
               image: dataDetailProductPage?.image || '',
               name: dataDetailProductPage?.name || '',
               price: dataDetailProductPage?.sizeAndPrice[indexSizeAndPrice]
                  .price,
               quantity: quantity,
               repo: dataDetailProductPage?.sizeAndPrice[indexSizeAndPrice]
                  .repo,
               size: dataDetailProductPage?.sizeAndPrice[indexSizeAndPrice]
                  .size,
               checked: true,
            }),
         );
                  ...
                  <div className=' w-full h-full text-black-main max-w-full'>
                     <h2
                        className={classNames(
                           'text-[28px] font-bold line-clamp-2',
                           {
                     ...
                     <Sizes
                        ...
                        data={
                           dataDetailProductPage?.sizeAndPrice
                              ? dataDetailProductPage?.sizeAndPrice.map(
                                   (item) => {
                                      return item.size;
                                   },
                                )
