...
export default function Overview(props: IOverviewProps) {
    return (
        <div className="mt-12 border border-gray-primary grid md:grid-cols-2 lg:grid-cols-4 min-h-[100px]">
            {takeActionData.overview.map((overview) => {
                return (
                    ...
                    >
                        <FontAwesomeIcon className="text-[54px] text-[#EF4444]" icon={overview.icon} />
                        <div className="">
                            <h6 className="uppercase text-xl font-semibold">{overview.title}</h6>
