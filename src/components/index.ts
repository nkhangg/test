...
export { default as DivAnitmation } from './animations/DivAnitmation';
...
export { default as Provinces } from './inputs/address/Provinces';
export { default as Districtes } from './inputs/address/Districtes';
