...
export default function ImpactOfYearItem({ data }: IImpactOfYearItemProps) {
    return (
        ...
        >
            ...
            <h4 className="font-bold text-green-main-dark text-2xl lg:text-[48px]">{data.quantity}</h4>
            <span className="text-lg lg:text-xl font-bold text-black-main">{data.title}</span>
        </div>
    );
}
